...
public class KeyboardConstants {
    ...
    public static final String SEND_TREAT_ACTIONBODY = "TREAT ";
    ...
    public static final int PRODUCT_FIRST_BUTTONS_ROWS = 3;
    public static final int PRODUCT_SECOND_BUTTONS_ROWS = 2;
